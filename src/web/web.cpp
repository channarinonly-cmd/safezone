...
std::string login_server_id = "thuay-ro";
std::string login_server_pw = "y4GSzqEAe36KD2MW";
std::string login_server_db = "thuay_ro_rag";

std::string char_server_ip = "127.0.0.1";
uint16  char_server_port = 3306;
std::string char_server_id = "thuay-ro";
std::string char_server_pw = "y4GSzqEAe36KD2MW";
std::string char_server_db = "thuay_ro_rag";

std::string map_server_ip = "127.0.0.1";
uint16 map_server_port = 3306;
std::string map_server_id = "thuay-ro";
std::string map_server_pw = "y4GSzqEAe36KD2MW";
std::string map_server_db = "thuay_ro_rag";

std::string web_server_ip = "127.0.0.1";
uint16 web_server_port = 3306;
std::string web_server_id = "thuay-ro";
std::string web_server_pw = "y4GSzqEAe36KD2MW";
std::string web_server_db = "thuay_ro_rag";

std::string default_codepage = "tis620";
...
void logger(const Request & req, const Response & res) {
	...
	// ซ่อน Log เฉพาะของระบบ /autoattack เพื่อไม่ให้รก Console
	if (req.path.find("/autoattack") == std::string::npos) {
