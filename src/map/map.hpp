...
enum _sp {
	...
	SP_AID_PERIOD_ADDSTOREITEMCOUNT,
};
...
enum e_mapflag : int16 {
	...
	MF_GREENHEADPK,
	MF_NOSTAMINA,
	MF_NOFACTIONWAR, // [Addon] เขตสันติภาพ ห้ามสงคราม 2 เมือง
	MF_MAX
};
...
enum cell_t{
	...
	CELL_ICEWALL,
	CELL_NOBUYINGSTORE,
	CELL_PVP,		// Addon Cell PVP
	CELL_NOFACTIONWAR,	// <--- [Addon] เพิ่มบรรทัดนี้
};
...
enum cell_chk : uint8 {
	...
	CELL_CHKPVP,		// Addon Cell PVP
	CELL_CHKNOFACTIONWAR,	// <--- [Addon] เพิ่มบรรทัดนี้
...
struct mapcell
{
	...
	unsigned char
		...
		maelstrom : 1,
		icewall : 1,
		pvp : 1,	// Addon Cell PVP
		nobuyingstore : 1,
		nofactionwar : 1; // <--- [Addon] เพิ่มบรรทัดนี้ลงไป (อย่าลืมเปลี่ยน , อันบนเป็นคอมม่าถ้ามันเป็นเซมิโคลอนอยู่นะครับ)
...
struct map_data {
	...
	int users;
	int users_pvp;
	int cell_pvpuser;		// Addon Cell PVP
	...
	// --- Custom System ---
	int mob_damagerate; 
	std::unordered_map<uint16, int> custom_skill_dmg; 
	// ---------------------
