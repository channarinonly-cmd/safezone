...
enum e_ai_skill_type : uint8 {
	SKILL_TYPE_NONE 	= 0x0,
	SKILL_TYPE_ATTACK	= 0x1,
	SKILL_TYPE_SUPPORT	= 0x2,
	SKILL_TYPE_HEAL		= 0x4,
};
...
enum e_get_info_string : uint8 {
	...
	GET_INFO_STOP_WALK		= 13,
	GET_INFO_REVIVE			= 14,
	GET_INFO_PARTY_AUTO		= 15,	
	GET_INFO_HEAL_PARTY		= 16,	
};
...
extern std::vector<uint16> skill_mcri_list; //m_cri
extern std::vector<std::string> mapname_list; //pk pass
#endif /* SKILL_HPP */
