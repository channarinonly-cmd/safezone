...
enum sc_type : int16 {
	...
	**/
	...
	SC_AID_PERIOD_RECEIVEITEM_ETC,
	SC_AID_PERIOD_RECEIVEITEM_USABLE,
	SC_AID_PERIOD_RECEIVEITEM_EQUIP,
	SC_AID_PERIOD_RECEIVEITEM_CARD,
	SC_AID_PERIOD_PLUSEXP_2ND,
	SC_AID_PERIOD_RECEIVEITEM_2ND_ETC,
	SC_AID_PERIOD_RECEIVEITEM_2ND_USABLE,
	SC_AID_PERIOD_RECEIVEITEM_2ND_EQUIP,
	SC_AID_PERIOD_RECEIVEITEM_2ND_CARD,
	...
	SC_HUNGRY3,
	SC_HUNGRY4,	
	SC_ZENYGUM, // [Custom] บัฟคูณเงิน Zeny Drop
	SC_FACTION_BUFF,
...
/// @APIHOOK_START(EFST_ENUM)
	...
	EFST_AID_PERIOD_RECEIVEITEM_ETC,
	EFST_AID_PERIOD_RECEIVEITEM_USABLE,
	EFST_AID_PERIOD_RECEIVEITEM_EQUIP,
	EFST_AID_PERIOD_RECEIVEITEM_CARD,
	EFST_AID_PERIOD_RECEIVEITEM_2ND_ETC,
	EFST_AID_PERIOD_RECEIVEITEM_2ND_USABLE,
	EFST_AID_PERIOD_RECEIVEITEM_2ND_EQUIP,
	EFST_AID_PERIOD_RECEIVEITEM_2ND_CARD,

	EFST_REDHEADPK = 1640,
	EFST_PURPLEHEADPK = 1641,
	EFST_GREENHEADPK = 1642,

	EFST_GUM_ETC = 1801,
	EFST_GUM_USABLE = 1802,
	EFST_GUM_EQUIP = 1803,
	EFST_GUM_CARD = 1804,
...
struct s_char_bonus {
	...
	std::string job_name;       // 👈 เพิ่มบรรทัดนี้
	std::string script_text;    // 👈 เพิ่มบรรทัดนี้
...
private:
	uint16 entry_id; // 👈 เพิ่มตัวแปรสำหรับรันลำดับตรงนี้
public:
	CharBonusDatabase() : TypesafeYamlDatabase( "CHAR_BONUS_DB", 1 ){
		entry_id = 0; // 👈 ตั้งค่าเริ่มต้นเป็น 0
	}

	void clear() override {
		TypesafeYamlDatabase::clear();
		entry_id = 0; // 👈 รีเซ็ตกลับเป็น 0 ทุกครั้งที่มีการ @reloadstatusdb
	}
...
int aa_shurikenchange(map_session_data * sd, mob_data *md);
...
class NoSkillDatabase : public TypesafeYamlDatabase<uint16, s_no_skill>{
public:
	NoSkillDatabase() : TypesafeYamlDatabase( "NO_SKILL_DB", 1 ){
...
extern NoSkillDatabase no_skill_db;
