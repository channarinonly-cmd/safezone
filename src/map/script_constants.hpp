...
#define SCRIPT_CONSTANTS_HPP
	...
	export_constant(MF_NOCASTSKILL);
	export_constant(MF_REDHEADPK);
	export_constant(MF_GREENHEADPK);

	export_constant(MF_NOSTAMINA);
	...
	export_constant2("bMagicHPDrainRate",SP_MAGIC_HP_DRAIN_RATE);
	export_constant2("bMagicSPDrainRate",SP_MAGIC_SP_DRAIN_RATE);;
	...
	export_constant2("bAddstoreitemcount", SP_AID_PERIOD_ADDSTOREITEMCOUNT);
	...
	export_constant(EQP_TWO_HAND);
	export_constant(EQP_HEAD_TOPMID);
	export_constant(EQP_HEAD_TOPLOW);
	export_constant(EQP_HEAD_MIDLOW);
	export_constant(EQP_HEAD_HEADFULL);
	export_constant(EQP_SHADOW_TWO_HAND);
	export_constant(EQP_SHADOW_HEAD_TOPMID);
	export_constant(EQP_SHADOW_HEAD_TOPLOW);
	export_constant(EQP_SHADOW_HEAD_MIDLOW);
	export_constant(EQP_SHADOW_HEAD_HEADFULL);
	...
	export_constant(SC_ZENYGUM);
	export_constant(EFST_ZENYGUM);
	export_constant(SC_FACTION_BUFF);
	export_constant(EFST_FACTION_BUFF);
	...
	export_constant(SC_AID_PERIOD_RECEIVEITEM_ETC);
	export_constant(SC_AID_PERIOD_RECEIVEITEM_USABLE);
	export_constant(SC_AID_PERIOD_RECEIVEITEM_EQUIP);
	export_constant(SC_AID_PERIOD_RECEIVEITEM_CARD);
	export_constant(SC_AID_PERIOD_PLUSEXP_2ND);
	export_constant(SC_AID_PERIOD_RECEIVEITEM_2ND_ETC);
	export_constant(SC_AID_PERIOD_RECEIVEITEM_2ND_USABLE);
	export_constant(SC_AID_PERIOD_RECEIVEITEM_2ND_EQUIP);
	export_constant(SC_AID_PERIOD_RECEIVEITEM_2ND_CARD);

	export_constant(SC_GUM_ETC);
	export_constant(SC_GUM_USABLE);
	export_constant(SC_GUM_EQUIP);
	export_constant(SC_GUM_CARD);

	export_constant(SC_REDHEADPK);
	export_constant(SC_PURPLEHEADPK);
	export_constant(SC_GREENHEADPK);

	export_constant(SC_STAMINA);
	export_constant(SC_AUTOATTACK);
	export_constant(SC_HUNGRY1);
	export_constant(SC_HUNGRY2);
	export_constant(SC_HUNGRY3);
	export_constant(SC_HUNGRY4);
...
/// @APIHOOK_START(EFST_CONST)
	...
	export_constant(EFST_AID_PERIOD_RECEIVEITEM_ETC);
	export_constant(EFST_AID_PERIOD_RECEIVEITEM_USABLE);
	export_constant(EFST_AID_PERIOD_RECEIVEITEM_EQUIP);
	export_constant(EFST_AID_PERIOD_RECEIVEITEM_CARD);
	export_constant(EFST_AID_PERIOD_RECEIVEITEM_2ND_ETC);
	export_constant(EFST_AID_PERIOD_RECEIVEITEM_2ND_USABLE);
	export_constant(EFST_AID_PERIOD_RECEIVEITEM_2ND_EQUIP);
	export_constant(EFST_AID_PERIOD_RECEIVEITEM_2ND_CARD);

	export_constant(EFST_GUM_ETC);
	export_constant(EFST_GUM_USABLE);
	export_constant(EFST_GUM_EQUIP);
	export_constant(EFST_GUM_CARD);

	export_constant(EFST_REDHEADPK);
	export_constant(EFST_PURPLEHEADPK);
	export_constant(EFST_GREENHEADPK);

	export_constant(EFST_STAMINA);
	export_constant(EFST_AUTOATTACK);
	export_constant(EFST_HUNGRY1);
	export_constant(EFST_HUNGRY2);
	export_constant(EFST_HUNGRY3);
	export_constant(EFST_HUNGRY4);
...
/// Do not modify code above this, since it will be automatically generated by the API again
	...
	export_constant(IG_RANDOM_CARDS);
	
	export_constant(IG_CUSTOME_BOX1);
	export_constant(IG_CUSTOME_BOX2);
	export_constant(IG_CUSTOME_BOX3);
	export_constant(IG_CUSTOME_BOX4);
	export_constant(IG_CUSTOME_BOX5);
	export_constant(IG_CUSTOME_BOX6);
	export_constant(IG_CUSTOME_BOX7);
	export_constant(IG_CUSTOME_BOX8);
	export_constant(IG_CUSTOME_BOX9);
	export_constant(IG_CUSTOME_BOX10);
	export_constant(IG_CUSTOME_BOX11);
	export_constant(IG_CUSTOME_BOX12);
	export_constant(IG_CUSTOME_BOX13);
	export_constant(IG_CUSTOME_BOX14);
	export_constant(IG_CUSTOME_BOX15);
	export_constant(IG_CUSTOME_BOX16);
	export_constant(IG_CUSTOME_BOX17);
	export_constant(IG_CUSTOME_BOX18);
	export_constant(IG_CUSTOME_BOX19);
	export_constant(IG_CUSTOME_BOX20);
	export_constant(IG_CUSTOME_BOX21);
	export_constant(IG_CUSTOME_BOX22);
	export_constant(IG_CUSTOME_BOX23);
	export_constant(IG_CUSTOME_BOX24);
	export_constant(IG_CUSTOME_BOX25);
	export_constant(IG_CUSTOME_BOX26);
	export_constant(IG_CUSTOME_BOX27);
	export_constant(IG_CUSTOME_BOX28);
	export_constant(IG_CUSTOME_BOX29);
	export_constant(IG_CUSTOME_BOX30);
	export_constant(IG_CUSTOME_BOX31);
	export_constant(IG_CUSTOME_BOX32);
	export_constant(IG_CUSTOME_BOX33);
	export_constant(IG_CUSTOME_BOX34);
	export_constant(IG_CUSTOME_BOX35);
	export_constant(IG_CUSTOME_BOX36);
	export_constant(IG_CUSTOME_BOX37);
	export_constant(IG_CUSTOME_BOX38);
	export_constant(IG_CUSTOME_BOX39);
	export_constant(IG_CUSTOME_BOX40);
	export_constant(IG_CUSTOME_BOX41);
	export_constant(IG_CUSTOME_BOX42);
	export_constant(IG_CUSTOME_BOX43);
	export_constant(IG_CUSTOME_BOX44);
	export_constant(IG_CUSTOME_BOX45);
	export_constant(IG_CUSTOME_BOX46);
	export_constant(IG_CUSTOME_BOX47);
	export_constant(IG_CUSTOME_BOX48);
	export_constant(IG_CUSTOME_BOX49);
	export_constant(IG_CUSTOME_BOX50);
	export_constant(IG_CUSTOME_BOX51);
	export_constant(IG_CUSTOME_BOX52);
	export_constant(IG_CUSTOME_BOX53);
	export_constant(IG_CUSTOME_BOX54);
	export_constant(IG_CUSTOME_BOX55);
	export_constant(IG_CUSTOME_BOX56);
	export_constant(IG_CUSTOME_BOX57);
	export_constant(IG_CUSTOME_BOX58);
	export_constant(IG_CUSTOME_BOX59);
	export_constant(IG_CUSTOME_BOX60);
	export_constant(IG_CUSTOME_BOX61);
	export_constant(IG_CUSTOME_BOX62);
	export_constant(IG_CUSTOME_BOX63);
	export_constant(IG_CUSTOME_BOX64);
	export_constant(IG_CUSTOME_BOX65);
	export_constant(IG_CUSTOME_BOX66);
	export_constant(IG_CUSTOME_BOX67);
	export_constant(IG_CUSTOME_BOX68);
	export_constant(IG_CUSTOME_BOX69);
	export_constant(IG_CUSTOME_BOX70);
	export_constant(IG_CUSTOME_BOX71);
	export_constant(IG_CUSTOME_BOX72);
	export_constant(IG_CUSTOME_BOX73);
	export_constant(IG_CUSTOME_BOX74);
	export_constant(IG_CUSTOME_BOX75);
	export_constant(IG_CUSTOME_BOX76);
	export_constant(IG_CUSTOME_BOX77);
	export_constant(IG_CUSTOME_BOX78);
	export_constant(IG_CUSTOME_BOX79);
	export_constant(IG_CUSTOME_BOX80);
	export_constant(IG_CUSTOME_BOX81);
	export_constant(IG_CUSTOME_BOX82);
	export_constant(IG_CUSTOME_BOX83);
	export_constant(IG_CUSTOME_BOX84);
	export_constant(IG_CUSTOME_BOX85);
	export_constant(IG_CUSTOME_BOX86);
	export_constant(IG_CUSTOME_BOX87);
	export_constant(IG_CUSTOME_BOX88);
	export_constant(IG_CUSTOME_BOX89);
	export_constant(IG_CUSTOME_BOX90);
	export_constant(IG_CUSTOME_BOX91);
	export_constant(IG_CUSTOME_BOX92);
	export_constant(IG_CUSTOME_BOX93);
	export_constant(IG_CUSTOME_BOX94);
	export_constant(IG_CUSTOME_BOX95);
	export_constant(IG_CUSTOME_BOX96);
	export_constant(IG_CUSTOME_BOX97);
	export_constant(IG_CUSTOME_BOX98);
	export_constant(IG_CUSTOME_BOX99);
	export_constant(IG_CUSTOME_BOX100);
	...
	export_constant(HAT_EF_C_REDHEADPK);
	export_constant(HAT_EF_C_PURPLEHEADPK);
	...
	export_constant(GET_INFO_STOP_WALK);	
	export_constant(GET_INFO_REVIVE);		
	export_constant(GET_INFO_PARTY_AUTO);	
	export_constant(GET_INFO_HEAL_PARTY);	
