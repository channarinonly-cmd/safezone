...
#define MAX_SKILL 1625 ///Maximum skill can be hold by Player, Homunculus, & Mercenary (skill list) AND skill_db limit
...
enum equip_pos : uint32 {
	...
	EQP_TWO_HAND		= EQP_HAND_R|EQP_HAND_L,
	EQP_HEAD_TOPMID 	= EQP_HEAD_TOP|EQP_HEAD_MID,
	EQP_HEAD_TOPLOW 	= EQP_HEAD_TOP|EQP_HEAD_LOW,
	EQP_HEAD_MIDLOW 	= EQP_HEAD_MID|EQP_HEAD_LOW,
	EQP_HEAD_HEADFULL 	= EQP_HEAD_TOP|EQP_HEAD_MID|EQP_HEAD_LOW,

	EQP_SHADOW_TWO_HAND	= EQP_SHADOW_WEAPON|EQP_SHADOW_ARMOR,
	EQP_SHADOW_HEAD_TOPMID = EQP_COSTUME_HEAD_TOP|EQP_COSTUME_HEAD_MID,
	EQP_SHADOW_HEAD_TOPLOW = EQP_COSTUME_HEAD_TOP|EQP_COSTUME_HEAD_LOW,
	EQP_SHADOW_HEAD_MIDLOW = EQP_COSTUME_HEAD_MID|EQP_COSTUME_HEAD_LOW,
	EQP_SHADOW_HEAD_HEADFULL = EQP_COSTUME_HEAD_TOP|EQP_COSTUME_HEAD_MID|EQP_COSTUME_HEAD_LOW,
};
...
struct mmo_charstatus {
	...
	short shield, costume_shield; // enum weapon_type
...
#define SP_MAGIC_HP_DRAIN_RATE 10001
#define SP_MAGIC_SP_DRAIN_RATE 10002
