...
ifeq ($(HAVE_MYSQL),yes)
	...
	SERVER_DEPENDS=common login char map web voice import
...
help:
	...
	@echo "'voice'       - builds voice server"
	...
	@echo "'server'      - builds servers (targets 'common' 'login' 'char' 'map' 'web' 'voice' and 'import')"
